...
Master registry of subsystems **present in this repository**. Each subsystem has (or will have) a spec in `.gald3r/subsystems/{name}.md` — read it before changing that area.
...
*(No subsystems yet — use `@g-subsystems` to register the first subsystem)*
