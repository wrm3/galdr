...
> This is galdr's **6th IDE platform** at the **Phase 1 "compatible"** level.
...
## galdr + Copilot: What Works Today
...
| Skills | ❌ | Phase 2 — awaits galdr_valhalla MCP URL |
...
1. `.github/copilot-instructions.md` — repository-wide instructions (galdr always-apply rules live here)
...
@workspace Apply the galdr code review checklist to this file
```

## Workspace Instructions (copilot-instructions.md)

galdr's always-apply rules are automatically compiled into `.github/copilot-instructions.md` by:
...
- Writes to `.github/copilot-instructions.md` and `template_full/.github/copilot-instructions.md`
...
- Use `.github/copilot-instructions.md` to carry galdr rules to Copilot IDE sessions
- Coordinate via `.galdr/linking/INBOX.md` PCAC messages as usual
- Copilot users work in their IDE; task status is updated in `.galdr/tasks/` files manually

Phase 2 will add `.github/agents/*.agent.md` to enable agent-mode invocation once galdr_valhalla provides a public MCP server URL.
