---
name: g-skl-qa
description: Track bugs, QA, and fixes in .galdr/. For bug reports, issues, quality, fixes, QA workflows.
---
...
This Skill works with Cursor's galdr QA system. The system uses:
