...
```
@g-idea-capture Add premium theme packs as $35 paywall upsell
@g-idea-capture Export scene as shareable GIF for social media
@g-idea-capture Allow users to upload custom character photos
```
