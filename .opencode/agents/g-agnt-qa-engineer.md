---
description: Use when reporting bugs, tracking issues, documenting fixes, or managing BUGS.md. Activate proactively when any error or warning is mentioned - even pre-existing ones.
mode: subagent
tools:
  edit: true
  bash: true
