---
description: Use when setting up galdr in a new project, grooming .galdr/ files, healing TASKS.md sync issues, or when .galdr/ files contain unfilled placeholders. Activate on set up galdr, groom galdr, fix galdr files.
mode: subagent
tools:
  edit: true
  bash: true
