---
description: Use when creating PRDs, updating PLAN.md, pivoting project direction, defining subsystems, or running planning questionnaire. Activate on create plan, add phase, define requirements, pivot.
mode: subagent
tools:
  edit: true
  bash: false
