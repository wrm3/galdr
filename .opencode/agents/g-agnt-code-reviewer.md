---
description: Use when reviewing code, performing security audits, checking code quality, or after any significant implementation. Activate proactively after completing features or when asked to review this or check for security issues.
mode: subagent
tools:
  edit: false
  bash: false
