...
- Source: append to `.galdr/vault/log.md`
- Destination: append to `{dest}/.galdr/vault/log.md`
...
**Migrate a subsystem:**
```
@g-pcac-move template_full/.cursor/skills/g-skl-websocket-sync → galdr_mcp
```

**Promote a skill to canonical template:**
```
@g-pcac-move .cursor/skills/g-skl-new-thing → template_full
```

**Move vault research:**
```
@g-pcac-move .galdr/vault/research/topic.md → galdr_vault
```
