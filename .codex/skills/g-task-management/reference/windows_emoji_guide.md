...
The galdr system uses Windows-safe emojis for task status indicators. This document explains the emoji choices, why they're Windows-safe, and how to use them correctly.
...
**Example:**
```markdown
- [🔄] Task 002: Create galdr-planning Skill
```
...
The galdr system uses a carefully curated set of Windows-safe emojis that:
