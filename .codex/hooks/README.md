...
- It writes a human-readable transcript to `.gald3r/logs/*_codex_chat.log`

Codex may still require external lifecycle-hook support to invoke these scripts automatically.
