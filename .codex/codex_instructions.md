# Codex Platform — galdr Configuration Guide
...
1. **`AGENTS.md`** root file — Codex reads this natively; the galdr Enforcement Rules section contains all critical rules
...
# Define agent roles
[agents.task-manager]
description = "Manages galdr task lifecycle..."
```
...
- .galdr/ folder gate (use skills for all .galdr/ operations)
