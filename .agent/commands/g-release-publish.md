...
Scans `.galdr/releases/` for all `planned`, `in_progress`, and `released` files, sorts them by `target_date`, and writes `ROADMAP.md` at the project root as a two-section table (Upcoming + Released).
