...
### 1. Load Topology
Read `.galdr/linking/link_topology.md` to identify children.
...
- Append `[BROADCAST]` entry to `{child}/.galdr/linking/INBOX.md`
...
```
@g-pcac-order galdr_mcp: add oracle connection pool task
```
