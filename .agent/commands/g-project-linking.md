View or edit project linking (relationships in `PROJECT_TOPOLOGY.md`): $ARGUMENTS

## What This Command Does

Reads `.galdr/project/PROJECT_TOPOLOGY.md` and displays the current project's declared relationships — parents, children, and siblings. Use this to add new relationships or verify existing ones.
...
Contracts: .galdr/linking/oracle_connection_protocol.md
           .galdr/linking/cbs_api_interface.md
```
...
Follows the `g-project-linking` skill.
