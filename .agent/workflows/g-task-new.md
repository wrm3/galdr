...
Creates a properly structured task in the galdr system.
...
### 2. Create Task File
I'll generate a task file in `.galdr/tasks/` with:
...
**I MUST update BOTH:**
1. ✅ Task file in `.galdr/tasks/`
2. ✅ Entry in `.galdr/TASKS.md`
