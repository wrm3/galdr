...
Creates a new phase in the galdr planning system with **atomic synchronization** (TASKS.md header AND phase file created together).
...
#### B. Create Phase File
**Filename**: `.galdr/phases/phase{N}_{kebab-case-name}.md`
