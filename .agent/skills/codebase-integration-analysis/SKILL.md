...
description: Merge two or more of YOUR OWN projects together. Deep structural integration with full architecture mapping. Use ONLY when combining projects you own and control. For browsing external sources for ideas, use `g-harvest` instead.
---
