...
Opens `.galdr/linking/INBOX.md`, triages items by type, and routes each to the appropriate response action. CONFLICTs are surfaced first and block all other work until resolved. Uses `g-skl-pcac-read`.

## Workflow

### 1. Read INBOX
Open `.galdr/linking/INBOX.md`.
