"""
migrate_topics_to_tags.py — galdr vault frontmatter migration
...
Examples:
    ...
    python migrate_topics_to_tags.py --vault-path G:/galdr_ecosystem/galdr_vault --dry-run

    # Apply the migration:
    python migrate_topics_to_tags.py --vault-path G:/galdr_ecosystem/galdr_vault

    # Apply with verbose output:
    python migrate_topics_to_tags.py --vault-path G:/galdr_ecosystem/galdr_vault --verbose
"""
