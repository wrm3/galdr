...
2. **Learned facts**: Write session summaries to `.galdr/learned-facts.md` via `/g-learn`
...
- Gemini can write results to standard galdr task files for Cursor to pick up
- Coordinate via `.galdr/linking/INBOX.md` for structured handoffs
