...
```
# Claim galdr_master_control as this project's parent
@g-pcac-claim G:\galdr_ecosystem\galdr_master_control

# Claim without touching the parent project (remote/read-only)
@g-pcac-claim G:\galdr_ecosystem\galdr_master_control --one-way
```

## What Happens

1. Reads `.galdr/.identity` from both this project and the target parent
