...
# g-skl-claude-cli — Claude Code CLI
...
claude --mcp-server "galdr:node scripts/galdr-mcp.js"
...
Coordinate via `.galdr/linking/INBOX.md` for cross-agent messaging.
