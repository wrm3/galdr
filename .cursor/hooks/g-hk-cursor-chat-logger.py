#!/usr/bin/env python3
"""
Persist local chat history to .galdr/logs without MCP dependencies.
...
- writes a human-readable transcript to .galdr/logs/
"""
...
def write_chat_log(
    ...
    logs_dir = project_path / ".galdr" / "logs"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Write a local chat transcript to .galdr/logs")
