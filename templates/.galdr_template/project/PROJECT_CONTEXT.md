...
*(Set during @g-setup. delivery = building a defined product. research = exploring unknown solutions.)*
...
<!-- Updated by @g-cleanup nightly — DO NOT EDIT MANUALLY -->
...
**⚠️ MANDATORY: Read PROJECT_CONSTRAINTS.md before any coding.**
...
**Full list**: `.galdr/project/PROJECT_CONSTRAINTS.md`

---

## Active Sprint
**Sprint File**: `.galdr/config/SPRINT.md`
**Generated**: {timestamp}
...
- `.galdr/TASKS.md` — Master task list (source of truth)
- `.galdr/config/SPRINT.md` — Active sprint queue (auto-generated by cleanup agent)
- `.galdr/project/PROJECT_CONSTRAINTS.md` — Non-negotiable constraints
- `.galdr/tracking/BUGS.md` — Bug tracking
- `.galdr/experiments/SYSTEM_EXPERIMENTS.md` — System evolution log
- `.galdr/tracking/IDEA_BOARD.md` — Ideas (human + AI sections)
