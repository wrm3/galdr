...
**Full list**: `.galdr/ARCHITECTURE_CONSTRAINTS.md`

---

## Active Sprint
**Sprint File**: `.galdr/SPRINT.md`
**Generated**: {timestamp}
...
- `.galdr/SPRINT.md` — Active sprint queue (auto-generated by cleanup agent)
- `.galdr/ARCHITECTURE_CONSTRAINTS.md` — Non-negotiable constraints
- `.galdr/BUGS.md` — Bug tracking
- `.galdr/SYSTEM_EXPERIMENTS.md` — System evolution log
- `.galdr/IDEA_BOARD.md` — Ideas (human + AI sections)
