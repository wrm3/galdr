...
If the user is merging their own projects, redirect to `codebase-analyst` agent and `@g-analyze-codebase` command.
...
```
Read: .cursor/skills/g-harvest/SKILL.md
```
...
- Read `.galdr/PROJECT_CONTEXT.md` for mission
