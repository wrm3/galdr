...
Opens `.galdr/INBOX.md` and walks through all pending items — conflicts, parent broadcasts, child requests, and sibling peer syncs. Resolves conflicts, creates tasks for actionable items, and marks done items as complete.
