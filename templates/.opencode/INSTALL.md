...
1. Create a .galdr/ folder with: TASKS.md, PRD.md, SUBSYSTEMS.md, config/ (HEARTBEAT.md, SPRINT.md), project/ (PROJECT_CONTEXT.md, PROJECT_GOALS.md, PROJECT_CONSTRAINTS.md), experiments/ (HYPOTHESIS.md, SYSTEM_EXPERIMENTS.md), reports/ (CLEANUP_REPORT.md), tracking/ (BUGS.md, IDEA_BOARD.md, INBOX.md), subsystems/, tasks/, phases/
