# galdr-setup-user.ps1
# Run this ONCE from a terminal to set your galdr user identity.
# Your user ID is stored in ~/.galdr/user_config.json and used across
# all AI sessions (Cursor, Claude Code, Gemini) on this machine.
#
# Usage:
#   powershell -ExecutionPolicy Bypass -File .cursor/hooks/g-setup-user.ps1

Write-Host ""
Write-Host "=======================================" -ForegroundColor Cyan
Write-Host "  galdr User Setup" -ForegroundColor Cyan
Write-Host "=======================================" -ForegroundColor Cyan
Write-Host ""
...
$configDir  = Join-Path $env:USERPROFILE ".galdr"
...
$cfg["created_by"]      = "galdr-setup-user.ps1"
...
Write-Host ""
Write-Host "This ID will be used for all galdr memory sessions on this machine." -ForegroundColor Gray
