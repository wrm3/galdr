...
> Detailed implementation rules for the galdr-qa Skill.
> These rules are derived from Cursor's galdr system.

## Overview

These rules provide comprehensive guidance for quality assurance using the galdr system. They cover bug tracking, severity classification, retroactive documentation, quality metrics, and integration with the task and planning systems.
...
**Cursor Rules Source**: `.cursor/rules/galdr/rules/qa.mdc`
